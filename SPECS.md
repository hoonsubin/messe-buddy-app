...
| **QR Validation**      | One optional Validation Method (`qr`): the Player generates a QR code and a Game Maker physically scans it. Preserved for contexts where physical co-location and camera access are available.                                                                                                                           |
