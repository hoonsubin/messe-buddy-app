...
export default function QRScannerPage(
  { sessionId, navigate }: QRScannerPageProps,
) {
  ...
  return (
    <div className="app-screen">
      ...
      <div className="p16" style={{ flex: 1 }}>
        ...
        >
          <div
            className="text-xs text-muted bold"
            style={{ marginBottom: 8, letterSpacing: "0.06em" }}
          >
            SCAN RESULT
          </div>
          ...
          {scanState === "idle"
            ...
            : (
              <>
                ...
                <div
                  style={{ fontWeight: 500, fontSize: "0.9rem", marginTop: 2 }}
                >
                  Meet Your Manager
                </div>
              </>
        ...
        {scanState === "scanned" && (
          <div style={{ display: "flex", gap: 10 }}>
            <button
              type="button"
              className="btn btn-success flex1 btn-lg"
            ...
            <button
              type="button"
              className="btn btn-danger flex1 btn-lg"
