...
export default function LandingPage({ navigate }: LandingPageProps) {
  ...
  function handleCreate() {
    navigate({
      name: "adminCockpit",
      sessionId: sessionId.trim() || "demo-2026",
    });
  }
      ...
      <div className="app-screen">
        ...
        <div className="p16">
          <div className="col mt8">
            <label className="text-xs bold uppercase text-muted">
              Session ID
            </label>
            <input
              className="input"
            ...
            <p className="text-xs text-muted">
              Your Game Maker will share this with you.
            </p>
          </div>
          {error && <p className="text-xs text-danger">{error}</p>}
          <button
            type="button"
            className="btn btn-primary btn-full btn-lg mt12"
            onClick={handleJoin}
          >
            Join →
          </button>
      ...
      <div className="app-screen">
        ...
        <div className="p16">
          <div className="col mt8">
            ...
            />
            <p className="text-xs text-muted">
              The 8-character key shown when you first joined.
            </p>
          </div>
          {error && <p className="text-xs text-danger">{error}</p>}
          <button
    ...
    <div className="app-screen">
      ...
      <div className="p16">
        ...
        <button
          ...
          onClick={() => setMode("joinPlayer")}
        >
          Join Session →
        </button>
        <p className="text-xs text-muted mt4">
          Enter your Session ID or open your invite link.
        </p>
        ...
        >
          <div
            ...
            style={{ color: "var(--warn)", marginBottom: 3 }}
          >
            Save your Recovery Key
          </div>
          <div className="text-xs text-muted">
            Shown once on first join. Copy and save it — you'll need it if you
            switch devices.
          </div>
        </div>
      </div>
