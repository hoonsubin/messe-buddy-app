...
export default function PlayerDetailPage(
  { sessionId, playerId, navigate }: PlayerDetailPageProps,
) {
  ...
  return (
    <div className="app-screen">
      ...
      <div className="scroll">
        {/* Profile header */}
        <div
          style={{ background: "var(--brand-deeper)", padding: "14px 16px" }}
        >
          <div className="row gap8">
            ...
            <div className="flex1">
              <div
                style={{ fontSize: "1.05rem", fontWeight: 600, color: "#fff" }}
              >
                {player.name}
              </div>
              <div
                style={{ fontSize: "0.78rem", color: "#7AB8E8", marginTop: 2 }}
              >
          ...
          <div style={{ marginTop: 10 }}>
            <div className="pbar">
              <div
                className="pbar-fill primary"
                style={{ width: `${overallPct}%` }}
              />
            </div>
            <div
              style={{ fontSize: "0.68rem", color: "#7AB8E8", marginTop: 4 }}
            >
          ...
          {MOCK_MILESTONES.map((ms) => {
            ...
            return (
              <div key={ms.id} className="ms-row">
                ...
                <div
                  className="ms-row-name"
                  style={{
                    color: ms.status === "locked" || ms.status === "upcoming"
                      ? "var(--text-muted)"
                      : "var(--text)",
                  }}
                >
                ...
                <div className="ms-row-xp" style={{ color: col }}>
                  {ms.earnedXP}/{ms.xpThreshold}
                </div>
              </div>
            );
          })}
          ...
          >
            <div>
              ...
              <div className="text-xs text-muted mt4">
                Awaiting GM scan · Hall A4 · +30 XP
              </div>
            </div>
            <button
              type="button"
