...
export interface AppAdapter {
  ...
  updateSession(sessionId: string, patch: Partial<Omit<Session, keyof PBRecord>>): Promise<Session>;
  ...
  updatePlayer(playerId: string, patch: Partial<Omit<Player, keyof PBRecord>>): Promise<Player>;
  getPlayerByRecoveryKey(recoveryKey: string, sessionId: string): Promise<Player | null>;
  ...
  updateMilestone(milestoneId: string, patch: Partial<Omit<Milestone, keyof PBRecord>>): Promise<Milestone>;
  ...
  updateMission(missionId: string, patch: Partial<Omit<Mission, keyof PBRecord>>): Promise<Mission>;
  deleteMission(missionId: string): Promise<void>;

  // FormSchemas
  getFormSchema(missionId: string): Promise<FormSchema | null>;
  upsertFormSchema(missionId: string, fields: ReadonlyArray<FieldSchema>): Promise<FormSchema>;
  ...
  updateResource(resourceId: string, patch: Partial<Omit<Resource, keyof PBRecord>>): Promise<Resource>;
