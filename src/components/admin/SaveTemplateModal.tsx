...
const SaveTemplateModal = (props: SaveTemplateModalProps) => {
  ...
  return (
    <div className="modal-backdrop" onClick={props.onCancel} data-testid="save-template-modal">
      <div className="modal" role="dialog" aria-modal="true" aria-labelledby="save-template-title" onClick={(e) => e.stopPropagation()}>
        <h2 id="save-template-title" style={{ margin: 0, fontSize: "var(--text-lg)", fontWeight: "var(--weight-semibold)" }}>
          Save as template
        </h2>
