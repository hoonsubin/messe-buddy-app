...
import type { Player, BuddyProfile, PBRecord } from "../../types/index.ts";
...
interface BuddyAssignmentFormProps {
  ...
  readonly onDraftChange: (draft: Omit<BuddyProfile, keyof PBRecord | "assignedToPlayerId">) => void;
...
const BuddyAssignmentForm = (props: BuddyAssignmentFormProps) => (
  ...
  >
    <div className="form-field">
      <label className="form-label" htmlFor="buddy-player-select">Assign to player</label>
      <select
    ...
    <div className="form-field">
      ...
      <input
        ...
        onChange={(e) => props.onDraftChange({ ...props.draft, role: e.target.value })}
    ...
    <div className="form-field">
      ...
      <input
        ...
        onChange={(e) => props.onDraftChange({ ...props.draft, tenure: e.target.value })}
    ...
    <div className="form-field">
      ...
      <input
        ...
        onChange={(e) => props.onDraftChange({ ...props.draft, contactUrl: e.target.value })}
        placeholder="https://..."
      />
    </div>
    <button type="submit" className="btn btn--primary">Save buddy assignment</button>
  </form>
);
